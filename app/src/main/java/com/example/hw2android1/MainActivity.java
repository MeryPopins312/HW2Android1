package com.example.hw2android1;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void setClickOfFirst(View view) {
        Intent intent = new Intent(this, com.example.intents.SecondActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == KEY && resultCode == Activity.RESULT_OK && data != null) {
            imgViewOfFirst.setImageURI(data.getParcelableExtra(com.example.intents.SecondActivity.KEYS));
